...
- KSK (Key Signing Key - Khóa ký khóa): Một cặp khóa (Public/Private). Nhiệm vụ chính của KSK là ký lên bản ghi DNSKEY (chứa ZSK).
...
- DS (Delegation Signer) chứa một giá trị băm của public key của zone con.
- DS của my.lab.test được sinh từ khóa của zone con rồi đặt vào zone cha lab.test
